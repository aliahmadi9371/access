...
#define UART_Debug_RX_BUFFER_SIZE                 (1024u)
...
/* Only if RX is enabled */
    ...
    uint16 UART_Debug_GetRxBufferSize(void)
                                                            ;
...
/* Only if TX is enabled */
    ...
    void UART_Debug_PutArray(const uint8 string[], uint16 byteCount)
                                                            ;
    ...
    uint16 UART_Debug_GetTxBufferSize(void)
                                                            ;
    /* Obsolete functions, defines for backward compatible */
...
extern uint8 UART_Debug_initVar;
    ...
    extern volatile uint16 UART_Debug_txBufferRead;
    extern uint16 UART_Debug_txBufferWrite;
    ...
    extern volatile uint16 UART_Debug_rxBufferRead;
    extern volatile uint16 UART_Debug_rxBufferWrite;
