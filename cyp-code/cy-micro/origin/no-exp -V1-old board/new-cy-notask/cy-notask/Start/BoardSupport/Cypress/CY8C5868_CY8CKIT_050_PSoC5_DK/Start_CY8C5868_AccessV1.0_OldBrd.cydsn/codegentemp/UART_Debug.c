...
uint8 UART_Debug_initVar = 0u;
    ...
    volatile uint16 UART_Debug_txBufferRead = 0u;
    uint16 UART_Debug_txBufferWrite = 0u;
    ...
    volatile uint16 UART_Debug_rxBufferRead  = 0u;
    volatile uint16 UART_Debug_rxBufferWrite = 0u;
    ...
    void UART_Debug_PutChar(uint8 txDataByte) 
    {
        ...
        */
        ...
        while( (locTxBufferWrite < locTxBufferRead) ? (locTxBufferWrite == (locTxBufferRead - 1u)) :
                                ...
                                (uint16)(UART_Debug_TX_BUFFER_SIZE - 1u)) );
